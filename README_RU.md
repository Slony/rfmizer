...
| | `output_file_prefix` | Уникальная строка, с которой начинаются имена результирующих файлов. Применяется, чтобы отличать файлы, сформированные с использованием разных конфигурационных файлов. |
